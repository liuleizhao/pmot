...
<body>
	...
	<form class="classA mui-input-group" action="${ctx }/backend/appoint/platNumberWhiteList/add" method="post" name="form" id="form">
			...
			<tr>
				...
				<td class="text">
					<div class="mui-input-row">
						...
						value="<c:if test="${empty platNumberWhiteList.platNumber }">B</c:if>${fn:substring(platNumberWhiteList.platNumber,1,fn:length(platNumberWhiteList.platNumber))}" 
...
$(function(){
	...
	jQuery(document).ready(function() {	
			...
			// 新车标记
			var newFlag = '${platNumberWhiteList.newflag}';
			if(newFlag ==1){
