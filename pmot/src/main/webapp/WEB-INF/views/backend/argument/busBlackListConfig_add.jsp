...
<body>
	...
	<form class="classA mui-input-group" action="${ctx }/backend/blackListConfig/add" method="post" name="form" id="form">
		...
		<table cellpadding="8" cellspacing="1">
					...
					<div class="mui-input-row">
						<select name="recordType" id="recordType">
							<c:forEach items="${ recordTypes}" var="recordType">
								<option value="${recordType }">${recordType.description}</option>
							</c:forEach>
						</select>
			...
			<tr>
				...
				<td class="text">
					<div class="mui-input-row">
						<input name="effectDays" id="effectDays"  type="text"> 
					</div>
				</td>
				...
				<td class="text">
					<div class="mui-input-row">
						<input name="limitCount" id="limitCount"  type="text"> 
					</div>
				</td>
			</tr>
		</table>
