...
<body>
	...
	<form class="classA mui-input-group" action="${ctx }/backend/argument/sys_arg_value/add" method="post" name="form" id="form">
		<table cellpadding="8" cellspacing="1">
			<tr>
				<td class="field"><span class="txt-imp">*</span>参数值代码</td>
				<td class="text">
					<div class="mui-input-row">
						<input name="code" id="code" type="text"> <span id="check_code_exist" class="Prompt"></span>
					</div>
				</td>
				<td class="field"><span class="txt-imp">*</span>参数名称</td>
				<td class="text">
					<div class="mui-input-row">
						<input name="name" id="name" type="text"> <span id="check_name_exist" class="Prompt"></span>
					</div>
				</td>
			</tr>
			<tr>
		...
		<div class="mui-button-row">
			<input type="button" class="input_button" value="保存" id="addBtn"> 
	...
	$(function() {
		...
		$("#addBtn").click(function() {
			try {
				...
				$(this).validate.isNull($('#value').val(), '参数值不能为空');
