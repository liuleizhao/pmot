...
<script type='text/javascript' src='${ctx}/static/js/blockUI/jquery.blockUI.min.js'></script>	
...
<style type="text/css">
		...
		$(document).ready(function(){
				$.blockUI({
		        	...
		        	message:'<span style="font-size:12px;font-family: "宋体",Tahoma,Arial,helvetica,sans-serif;"><img src="${ctx}/static/images/front/busy.gif" />正在加载资源，请稍候...</span>'  
		     	});
			
			$.post("${ctx }/backend/system/organization/getOrganizations?changeOrgId="+"${changeOrgId}",
			   function(data){
			   $.unblockUI();
