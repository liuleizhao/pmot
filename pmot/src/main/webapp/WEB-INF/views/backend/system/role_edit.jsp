...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#addBtn").click(function() {
			try {
				/**************************check start****************************/
				$(this).validate.isNull($("#name").val(), '角色名称不能为 空');
...
<body>
	...
	<form class="classA mui-input-group z_99" action="${ctx }/backend/system/role/edit" method="post" name="form" id="editFrom">
		<input type="hidden" name="ids" id="ids" value="${resourceIds}"> <input type="hidden" name="id" id="id" value="${role.id}">
			...
			<tr>
				...
				<td class="text">
					<div class="mui-input-row">
						<input name="name" id="name" type="text" value="${role.name }" readonly="readonly"> <span id="check_name_exist" class="Prompt"></span>
					</div>
				</td>
