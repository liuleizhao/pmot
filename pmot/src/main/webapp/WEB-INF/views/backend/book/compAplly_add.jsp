...
<body>
	...
	<form class="classA mui-input-group" action="${ctx }/backend/book/compApplyAdd" method="post" name="form" id="form">
		<table cellpadding="8" cellspacing="1">
			<tr>
				<td class="field"><span class="txt-imp">*</span>企业名称</td>
				<td class="text">
					<div class="mui-input-row">
						<input name="companyName" id="companyName" type="text" value="${compApplyFrom.companyName }"/> <span id="companyName_info" class="Prompt"></span>
					</div>
				</td>
				<td class="field"><span class="txt-imp">*</span>申请数量</td>
				<td class="text">
					<div class="mui-input-row">
						<input type="text" name="" id="applyCount"> <span id="applyCount_info" class="Prompt"></span>
					</div>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="text">
					<div class="mui-input-row">
						<input name="enterpriseCrediteCode" id="enterpriseCrediteCode" type="text" value="${compApplyFrom.enterpriseCrediteCode }"/> <span id="compApplyFrom_info" class="Prompt"></span>
					</div>
				</td>
				<td class="field"><span class="txt-imp">*</span>组织机构代码</td>
				<td class="text">
					<div class="mui-input-row">
						<input name="organizationCode" id="organizationCode" type="text" value="${compApplyFrom.organizationCode }"> <span id="organizationCode_info" class="Prompt"></span>
					</div>
				</td>
			...
			<tr>
				...
				<td class="text">
					<div class="mui-input-row">
						<input name="startDate" id="startDate" type="text" value="${compApplyFrom.startDate }"/> <span id="startDate_info" class="Prompt"></span>
					</div>
				</td>
				<td class="field"><span class="txt-imp">*</span>终止日期</td>
				<td class="text">
					<div class="mui-input-row">
						<input name="endDate" id="endDate" type="text" value="${compApplyFrom.endDate }"/> <span id="endDate_info" class="Prompt"></span>
					</div>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="text" colspan="3">
					<textarea rows="5" cols="50" name="discription" id="discription"  value="${compApplyFrom.discription }"></textarea>
				</td>
			</tr>
		</table>
