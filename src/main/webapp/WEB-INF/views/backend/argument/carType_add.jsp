...
<body>
	...
	<form class="classA mui-input-group" action="${ctx }/backend/argument/carType/add" method="post" name="form" id="form">
		<table cellpadding="8" cellspacing="1">
			<tr>
				<td class="field"><span class="txt-imp">*</span>代号</td>
				<td class="text">
					<div class="mui-input-row">
						<input name="code" id="code" type="text" value="${carType.code}" />
			...
			<tr>
				...
				<td class="text">
					<div class="mui-input-row">
						<input type="text" name="orderNum" id="orderNum" placeholder="不能大于两位数" value="${carType.orderNum}" />
					</div>
				</td>
			</tr>
		</table>
